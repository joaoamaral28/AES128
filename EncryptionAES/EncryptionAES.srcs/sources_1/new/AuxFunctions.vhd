...
package AuxFunctions is
    ...
    function mult_mat_vec(
        ...
        return std_logic_vector;
    -- muliplty two given 4x4 matrixes
    function mult_mat(
        in_mat1 : Matrix;
        in_mat2:  Matrix)
        return Matrix;
...
package body AuxFunctions is
    function matrix_vec_xor(
        ...
        begin
            ...
            out_mat(0)(0) := in_mat(0)(0) xor in_vec(127 downto 120);
            out_mat(1)(0) := in_mat(1)(0) xor in_vec(119 downto 112);
            out_mat(2)(0) := in_mat(2)(0) xor in_vec(111 downto 104);
            out_mat(3)(0) := in_mat(3)(0) xor in_vec(103 downto 96);
            
            out_mat(0)(1) := in_mat(0)(1) xor in_vec(95 downto 88);
            out_mat(1)(1) := in_mat(1)(1) xor in_vec(87 downto 80);
            out_mat(2)(1) := in_mat(2)(1) xor in_vec(79 downto 72);
            out_mat(3)(1) := in_mat(3)(1) xor in_vec(71 downto 64);

            out_mat(0)(2) := in_mat(0)(2) xor in_vec(63 downto 56);
            out_mat(1)(2) := in_mat(1)(2) xor in_vec(55 downto 48);
            out_mat(2)(2) := in_mat(2)(2) xor in_vec(47 downto 40);
            out_mat(3)(2) := in_mat(3)(2) xor in_vec(39 downto 32);

            out_mat(0)(3) := in_mat(0)(3) xor in_vec(31 downto 24);
            out_mat(1)(3) := in_mat(1)(3) xor in_vec(23 downto 16);
            out_mat(2)(3) := in_mat(2)(3) xor in_vec(15 downto 8);
            out_mat(3)(3) := in_mat(3)(3) xor in_vec(7 downto 0);
        ...
        begin
            for i in 0 to 3 loop
                for j in 0 to 4 loop
                    out_mat(i)(j) := std_logic_vector(
                                        unsigned(in_mat1(i)(j)) * unsigned(in_mat2(j)(i)) 
                                        +
                                        unsigned(in_mat1(i)(j)) * unsigned(in_mat2(j)(i)));
                end loop;
            end loop;
